...
<body>
   ...
   <div class="slideshow-container">
      ...
      <div class="mySlides fade">
        <img src="hero_image.jpg" style="width:100%" width="100%" height="500px">
        <div class="text">You are on Amazon.com. You can also shp on Amazon India for millions of products with fast local delievery. <br>
          <a href="https://www.Amazon.in">Click here to go to Amazon.in</a></div>
      </div>
    
      <div class="mySlides fade">
        <img src="Amazon1.jpg" style="width:100%" width="100%" height="500px">
        <div class="text">You are on Amazon.com. You can also shp on Amazon India for millions of products with fast local delievery. <br>
          <a href="https://www.Amazon.in">Click here to go to Amazon.in</a></div>
      </div>
    
      <div class="mySlides fade">
        <img src="Amazonmy1.jpg" style="width:100%" width="100%" height="500px">
        <div class="text">You are on Amazon.com. You can also shp on Amazon India for millions of products with fast local delievery. <br>
